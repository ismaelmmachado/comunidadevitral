...
O footer DEVE (MUST) exibir no topo a tira de 4 cores (safira `#2f5f92`, esmeralda `#3f6f5a`, âmbar `#d99b2b`, rubi `#b3493a`) como marca inegociável, sobre o fundo gradiente petróleo.
